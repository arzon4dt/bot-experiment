...
heroStrength['npc_dota_hero_axe'] = 7
...
heroStrength['npc_dota_hero_bloodseeker'] = 6
...
heroStrength['npc_dota_hero_broodmother'] = -2 -- stupid minion control
...
heroStrength['npc_dota_hero_jakiro'] = 10
...
heroStrength['npc_dota_hero_warlock'] = 7
...
counters['npc_dota_hero_chaos_knight'] = {'npc_dota_hero_axe', 'npc_dota_hero_sven', 'npc_dota_hero_enigma', 'npc_dota_hero_phantom_lancer', 'npc_dota_hero_shredder',	'npc_dota_hero_warlock', 'npc_dota_hero_undying','npc_dota_hero_earthshaker', 'npc_dota_hero_brewmaster','npc_dota_hero_witch_doctor', 'npc_dota_hero_abyssal_underlord', 'npc_dota_hero_phoenix', 'npc_dota_hero_tidehunter', 'npc_dota_hero_terrorblade','npc_dota_hero_lich', 'npc_dota_hero_naga_siren'}
...
heroStrength['npc_dota_hero_sniper'] = 6

counters['npc_dota_hero_drow_ranger'] = {'npc_dota_hero_spectre', 'npc_dota_hero_centaur', 'npc_dota_hero_phantom_assassin', 'npc_dota_hero_spirit_breaker', 'npc_dota_hero_slark', 'npc_dota_hero_pudge', 'npc_dota_hero_chaos_knight', 'npc_dota_hero_axe', 'npc_dota_hero_riki', 'npc_dota_hero_bounty_hunter', 'npc_dota_hero_broodmother', 'npc_dota_hero_naga_siren'}
heroStrength['npc_dota_hero_drow_ranger'] = 3
...
heroStrength['npc_dota_hero_phantom_lancer'] = -1 -- hero is buggy, sometimes just stucks at the fountain
...
heroStrength['npc_dota_hero_centaur'] = 5
...
counters['npc_dota_hero_crystal_maiden'] = {'npc_dota_hero_axe', 'npc_dota_hero_bristleback',	'npc_dota_hero_pudge', 	'npc_dota_hero_zuus', 'npc_dota_hero_phoenix', 'npc_dota_hero_centaur', 'npc_dota_hero_undying', 'npc_dota_hero_axe', 'npc_dota_hero_silencer','npc_dota_hero_witch_doctor','npc_dota_hero_lich'}
...
heroStrength['npc_dota_hero_dark_seer'] = 3
...
heroStrength['npc_dota_hero_terrorblade'] = 10
...
heroStrength['npc_dota_hero_undying'] = 2

counters['npc_dota_hero_faceless_void'] = {'npc_dota_hero_broodmother','npc_dota_hero_meepo','npc_dota_hero_naga_siren','npc_dota_hero_enchantress','npc_dota_hero_storm_spirit','npc_dota_hero_death_prophet','npc_dota_hero_spectre','npc_dota_hero_phantom_lancer','npc_dota_hero_axe','npc_dota_hero_treant','npc_dota_hero_dragon_knight', 'npc_dota_hero_tidehunter'}
heroStrength['npc_dota_hero_faceless_void'] = 3

counters['npc_dota_hero_naga_siren'] = {'npc_dota_hero_leshrac','npc_dota_hero_abyssal_underlord','npc_dota_hero_dark_seer','npc_dota_hero_sand_king','npc_dota_hero_shredder','npc_dota_hero_earthshaker','npc_dota_hero_terrorblade','npc_dota_hero_jakiro','npc_dota_hero_necrolyte','npc_dota_hero_omniknight','npc_dota_hero_medusa','npc_dota_hero_zuus'}
heroStrength['npc_dota_hero_naga_siren'] = -5

counters['npc_dota_hero_pugna'] = {'npc_dota_hero_antimage','npc_dota_hero_pudge','npc_dota_hero_huskar','npc_dota_hero_bristleback','npc_dota_hero_chaos_knight','npc_dota_hero_medusa'}
heroStrength['npc_dota_hero_pugna'] = 3

counters['npc_dota_hero_grimstroke'] = {'npc_dota_hero_clinkz','npc_dota_hero_sniper','npc_dota_hero_arc_warden','npc_dota_hero_drow_ranger','npc_dota_hero_huskar','npc_dota_hero_bloodseeker'}
heroStrength['npc_dota_hero_grimstroke'] = 1

counters['npc_dota_hero_kunkka'] = {'npc_dota_hero_life_stealer','npc_dota_hero_death_prophet','npc_dota_hero_monkey_king','npc_dota_hero_obsidian_destroyer','npc_dota_hero_templar_assassin','npc_dota_hero_winter_wyvern','npc_dota_hero_dragon_knight','npc_dota_hero_juggernaut','npc_dota_hero_bloodseeker','npc_dota_hero_undying','npc_dota_hero_silencer'}
heroStrength['npc_dota_hero_kunkka'] = 2
...
function GetHeroStrength(heroName, enemies)
	...
	if counters[enemyName] ~= nil then
		...
		if cname == heroName then score = score + 1 + RandomInt(1,2) * role.GetRoleLevel(enemyName, 'carry') + RandomInt(1,2) * role.GetRoleLevel(heroName, 'carry') end
		 end
	end
	end
